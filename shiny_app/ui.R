...
tagList(  #needed for shinyjs
  ...
  navbarPage(
    ...
    tabPanel(
      ...
      p("Please note: there were an additional 41 staff tested at homes where the COVID status was not specified. During the week ending 24 January, there were 235 homes with active confirmed cases. Based on return of 1,054 of Scotland's 1,065 adult care homes."),
      hr(),
